...
describe('#index', () => {
  ...
  describe('#constructor()', () => {
    ...
    it('should set the provider variable to an instance of AwsProvider', () => expect(serverlessStepFunctions.provider).to.be.instanceof(serverless.getProvider('aws').constructor));
    ...
    it(
      'should run package:compileEvents promise chain in order when http event is empty',
      () => {
    ...
    it(
      'should run package:compileEvents promise chain in order',
      () => {
        const compileScheduledEventsStub = sinon
          .stub(serverlessStepFunctions, 'compileScheduledEvents').returns(BbPromise.resolve());
        const compileCloudWatchEventEventsStub = sinon
