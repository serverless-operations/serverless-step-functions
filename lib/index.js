  ...
  constructor(serverless, options, v3Api) {
    ...
    this.hooks = {
      ...
      'package:initialize': () => BbPromise.bind(this)
        .then(this.yamlParse),
      'before:deploy:stepf:getLambdaStackResource': () => BbPromise.bind(this)
        .then(this.yamlParse),
      'deploy:stepf:getLambdaStackResource': () => BbPromise.bind(this)
        .then(this.getLambdaStackResource),
      'deploy:stepf:getResourceNeedsToBeConfigured': () => BbPromise.bind(this)
        .then(this.getResourceNeedsToBeConfigured),
      'deploy:stepf:createDefinitionString': () => BbPromise.bind(this)
        .then(this.createDefinitionString),
      'deploy:stepf:callUpdateFunction': () => BbPromise.bind(this)
