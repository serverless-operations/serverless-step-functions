  ...
  return _.flatMap(taskStates, (state) => {
    ...
    switch (resourceName) {
      ...
      case 'arn:aws:states:::aws-sdk:sqs:receiveMessage':
        return getSqsPermissions(this.serverless, state, 'sqs:SendMessage');
      ...
      case 'arn:aws:states:::apigateway:invoke':
        return getApiGatewayPermissions('Invoke', state);

      case 'arn:aws:states:::aws-sdk:ssm:getParameters':
        return getSsmPermissions();
