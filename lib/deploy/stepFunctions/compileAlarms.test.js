...
describe('#compileAlarms', () => {
  ...
  it('should generate CloudWatch Alarms with nameTemplate', () => {
    ...
    expect(resources.StateCustomName1ExecutionsTimedOutAlarm.Properties.AlarmName)
      .to.be.equal('stateCustomName1-ExecutionsTimedOut-alarm');
    validateCloudWatchAlarm(resources.StateCustomName1ExecutionsTimedOutAlarm);
    expect(resources.StateCustomName1ExecutionsFailedAlarm.Properties.AlarmName)
      .to.be.equal('stateCustomName1-ExecutionsFailed-alarm');
    validateCloudWatchAlarm(resources.StateCustomName1ExecutionsFailedAlarm);
    expect(resources.StateCustomName1ExecutionsAbortedAlarm.Properties.AlarmName)
      .to.be.equal('stateCustomName1-ExecutionsAborted-alarm');
    validateCloudWatchAlarm(resources.StateCustomName1ExecutionsAbortedAlarm);
    expect(resources.StateCustomName1ExecutionThrottledAlarm.Properties.AlarmName)
      .to.be.equal('stateCustomName1-ExecutionThrottled-alarm');
  ...
  it('should generate CloudWatch Alarms with invalid nameTemplate', () => {
    ...
    expect(resources.StateCustomName2ExecutionsTimedOutAlarm.Properties)
      .not.have.property('AlarmName');
    validateCloudWatchAlarm(resources.StateCustomName2ExecutionsTimedOutAlarm);
    expect(resources.StateCustomName2ExecutionsFailedAlarm.Properties)
      .not.have.property('AlarmName');
    validateCloudWatchAlarm(resources.StateCustomName2ExecutionsFailedAlarm);
    expect(resources.StateCustomName2ExecutionsAbortedAlarm.Properties)
      .not.have.property('AlarmName');
    validateCloudWatchAlarm(resources.StateCustomName2ExecutionsAbortedAlarm);
    expect(resources.StateCustomName2ExecutionThrottledAlarm.Properties)
      .not.have.property('AlarmName');
