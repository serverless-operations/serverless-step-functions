...
describe('#methods()', () => {
  ...
  describe('#compileMethods()', () => {
    ...
    it(
      'should verify if http private parameter is correctly passed to resource',
  ...
  describe('#getMethodIntegration()', () => {
    ...
    it(
      'should set custom stateMachinelogical ID to RequestTemplates when customName is set',
      () => {
    ...
    it(
      'should set Access-Control-Allow-Origin header when cors is true',
      () => {
    ...
    it(
      ...
      () => {
        const integration = serverlessStepFunctions.getMethodIntegration('stateMachine', undefined, { timeoutInMillis: 10000 }).Properties.Integration;
    ...
    it(
      'should change passthroughBehavior and action when action is set',
      () => {
        expect(serverlessStepFunctions.getMethodIntegration('stateMachine', 'custom', {
    ...
    it(
      'should return a custom template for application/json when one is given',
      () => {
    ...
    it(
      'should return custom headers when one is given',
      () => {
    ...
    it(
      'should return custom headers and template when given',
      () => {
        const httpWithResponseHeaders = {
          path: 'foo/bar1',
          method: 'post',
    ...
    it(
      'should return a custom template for application/json when responses are given',
      () => {
        const httpWithResponseTemplate = {
          path: 'foo/bar1',
          method: 'post',
    ...
    it(
      'should return multiple custom templates for application/json when responses are given',
      () => {
        const httpWithResponseTemplate = {
          path: 'foo/bar1',
          method: 'post',
    ...
    it(
      'should return custom headers when when responses are given',
      () => {
        const httpWithResponseHeaders = {
          path: 'foo/bar1',
          method: 'post',
  ...
  it(
    'should return custom headers and template when responses are given',
    () => {
      const httpWithResponseHeaders = {
        path: 'foo/bar1',
        method: 'post',
  ...
  describe('#getIntegrationRequestTemplates()', () => {
    ...
    it(
      'should set custom stateMachinelogical ID in default templates when customName is set',
      () => {
        const requestTemplates = serverlessStepFunctions
    ...
    it(
      'should return the default for application/x-www-form-urlencoded when one is not given',
      () => {
        const httpWithoutRequestTemplate = {
          path: 'foo/bar1',
          method: 'post',
    ...
    it(
      'should return a custom template for application/x-www-form-urlencoded when one is given',
      () => {
        const httpWithRequestTemplate = {
          path: 'foo/bar1',
          method: 'post',
  ...
  describe('#getMethodResponses()', () => {
    ...
    it(
      'should set custom custom headers when one is given',
      () => {
        expect(serverlessStepFunctions.getMethodResponses({
          response: {
            headers: {
