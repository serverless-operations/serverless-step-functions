...
describe('awsCompileCloudWatchEventEvents', () => {
  ...
  describe('#compileCloudWatchEventEvents()', () => {
    itParam(
      'should throw an error if event type is not an object',
    ...
    itParam(
      'should throw an error if the "event" property is not given',
      ['cloudwatchEvent', 'eventBridge'],
      (source) => {
        serverlessStepFunctions.serverless.service.stepFunctions = {
          stateMachines: {
    ...
    itParam(
      'should create corresponding resources when events are given',
      ['cloudwatchEvent', 'eventBridge'],
      (source) => {
        serverlessStepFunctions.serverless.service.stepFunctions = {
          stateMachines: {
        ...
        expect(serverlessStepFunctions.serverless.service
          ...
          .FirstEventsRuleCloudWatchEvent1.Type).to.equal('AWS::Events::Rule');
        expect(serverlessStepFunctions.serverless.service
          .provider.compiledCloudFormationTemplate.Resources
          .FirstEventsRuleCloudWatchEvent2.Type).to.equal('AWS::Events::Rule');
        expect(serverlessStepFunctions.serverless.service
          .provider.compiledCloudFormationTemplate.Resources
    ...
    itParam(
      'should respect enabled variable, defaulting to true',
      ['cloudwatchEvent', 'eventBridge'],
      (source) => {
        serverlessStepFunctions.serverless.service.stepFunctions = {
          stateMachines: {
    ...
    itParam(
      'should respect eventBusName variable',
      ['cloudwatchEvent', 'eventBridge'],
      (source) => {
        serverlessStepFunctions.serverless.service.stepFunctions = {
          stateMachines: {
    ...
    itParam(
      'should respect eventBusName intrinsic function',
      ['cloudwatchEvent', 'eventBridge'],
      (source) => {
        serverlessStepFunctions.serverless.service.stepFunctions = {
          stateMachines: {
    ...
    itParam(
      'should respect deadLetterConfig variable',
      ['cloudwatchEvent', 'eventBridge'],
      (source) => {
        serverlessStepFunctions.serverless.service.stepFunctions = {
          stateMachines: {
        ...
        expect(serverlessStepFunctions.serverless.service
          .provider.compiledCloudFormationTemplate.Resources.FirstEventsRuleCloudWatchEvent1
          .Properties.Targets[0].DeadLetterConfig.Arn)
          .to.equal('arn:aws:sqs:us-east-1:012345678910:my-dlq');
      },
    );

    itParam(
      'should respect deadLetterConfig intrinsic function',
      ['cloudwatchEvent', 'eventBridge'],
      (source) => {
        serverlessStepFunctions.serverless.service.stepFunctions = {
          stateMachines: {
    ...
    itParam(
      'should respect input variable as an object',
      ['cloudwatchEvent', 'eventBridge'],
      (source) => {
        serverlessStepFunctions.serverless.service.stepFunctions = {
          stateMachines: {
    ...
    itParam(
      'should respect inputTransformer variable',
      ['cloudwatchEvent', 'eventBridge'],
      (source) => {
        serverlessStepFunctions.serverless.service.stepFunctions = {
          stateMachines: {
    ...
    itParam(
      'should throw an error when Input and InputPath and InputTransformer are set',
      ['cloudwatchEvent', 'eventBridge'],
      (source) => {
        serverlessStepFunctions.serverless.service.stepFunctions = {
          stateMachines: {
    ...
    itParam(
      'should respect variables if multi-line variables is given',
      ['cloudwatchEvent', 'eventBridge'],
      (source) => {
        serverlessStepFunctions.serverless.service.stepFunctions = {
          stateMachines: {
    ...
    itParam(
      'should respect iamRole intrinsic function',
      ['cloudwatchEvent', 'eventBridge'],
      (source) => {
        serverlessStepFunctions.serverless.service.stepFunctions = {
          stateMachines: {
    ...
    itParam(
      'should set RetryPolicy on target when retryPolicy is given',
      ['cloudwatchEvent', 'eventBridge'],
      (source) => {
        serverlessStepFunctions.serverless.service.stepFunctions = {
          stateMachines: {
    ...
    itParam(
      'should not set RetryPolicy on target when retryPolicy is not given',
      ['cloudwatchEvent', 'eventBridge'],
      (source) => {
        serverlessStepFunctions.serverless.service.stepFunctions = {
          stateMachines: {
    ...
    itParam('should support content filtering operators in event patterns: ${value}', ['cloudwatchEvent', 'eventBridge'], (source) => {
      // Regression test for #513 — content filtering patterns (prefix, numeric, exists, etc.)
      // are passed through as-is via JSON.stringify, so they must survive compilation unchanged.
      const event = {
        source: ['aws.orders'],
        detail: {
          appName: ['myappname'],
          eventName: [{ prefix: 'superevent' }],
          orderId: [{ numeric: ['>', 0, '<=', 100] }],
      ...
      const rule = serverlessStepFunctions.serverless.service.provider
        .compiledCloudFormationTemplate.Resources.FirstEventsRuleCloudWatchEvent1;
      expect(rule.Type).to.equal('AWS::Events::Rule');
      expect(rule.Properties.EventPattern).to.deep.equal(event);
    });
  });
});
